    ...
    const ListHeader = () => {
        ...
        return (
            <View>
                <View style={{ display: "flex", flexDirection: 'row', alignItems: "center", gap: 5, marginBottom: 10 }}>
                    <View style={{ borderRadius: 100, marginRight: 5 }}>
                        {user.profilePicture ? (
                            ...
                            <Avatar.Image size={60} style={{ marginHorizontal: 10, justifyContent: 'center', alignContent: 'center', alignItems: 'center'}} source={() => <Icon source="account" color={theme.colors.onPrimary} size={45}/>} />
                        )}
                    </View>
                ...
                <Card>
                    <Card.Content>
                        <Text variant="titleMedium">Home Course: <Text variant="titleMedium">{user.homeCourse}</Text></Text>
                ...
                <View style={{flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center'}}>
                    <Text variant="titleLarge" style={{ marginVertical: 10 }}>Recent Rounds</Text>
                    <Menu

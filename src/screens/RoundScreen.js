        ...
        <View style={{backgroundColor: theme.colors.surface, height: '100%'}}>
            {!rounds || rounds.length === 0 ? (
                <View style={{alignItems: 'center', justifyContent: 'center', gap: 50, height: '100%'}}>
                    ...
                    <Button mode="contained" style={{marginTop: 20}} onPress={() => navigation.navigate("AddRound")}>Add Round</Button>
                </View>
            ) : (
                <FlatList
                    ref={scrollRef}
                    ...
                    ListHeaderComponent={() =>
                        <View style={{flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center'}}>
                            <Text variant="titleLarge" style={{ margin: 10 }}>Recent Rounds</Text>
                            <Menu
                    ...
                    renderItem={({item}) =>
                        <Card style={{margin: 5, paddingVertical: 5, backgroundColor: theme.colors.elevation.level2}}>
                            <Card.Title
                                title={item.course}
                            ...
                            />
                            <View style={{display: 'flex', height: '75', flexDirection: 'row', justifyContent: 'space-around', paddingRight: 10 }}>
